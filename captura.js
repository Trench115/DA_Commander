...
const scoreRedEl = document.getElementById('scoreRedTop');
const scoreBlueEl = document.getElementById('scoreBlueTop');
...
const plusRedBtn = document.getElementById('plusRed');
const plusBlueBtn = document.getElementById('plusBlue');
...
function handleScoreButton(team, delta) {
  ...
  const card = team === 'red' ? scoreCardRed : scoreCardBlue;
...
plusRedBtn.addEventListener('click', (event) => {
  event.stopPropagation();
  handleScoreButton('red', 1);
});
plusBlueBtn.addEventListener('click', (event) => {
  event.stopPropagation();
  handleScoreButton('blue', 1);
});
